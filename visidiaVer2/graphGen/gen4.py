...
def genGraph(NoNodes=100,proximity=300,Xmax=1000,Ymax=1000,sep = 100,X1Comp=0,Y1Comp=0,X2Comp=1000,Y2Comp=1000):
	nodes = []
	compromisedNodeIds = []
...
if __name__ == '__main__':
	if(len(sys.argv) != 6):print("Usage: {} <NumberOfNodes> <Proximity> <MaximumX> <MaximumY> <Grid Seperation>".format(sys.argv[0]))
		...
		genGraph(args[0],args[1],args[2],args[3],args[4])
